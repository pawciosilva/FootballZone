    ...
    if (teams && matches.length > 0)
      setStats({
        ...
        homeWins:
          matches.filter(
            (item) =>
              item.event_final_result.split(/\s*/)[0] >
                item.event_final_result.split(/\s*/)[2] &&
                      ...
                      <div className="col-sm col-12 mb-sm-0 mb-3 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="w-75 progress" style={{ height: "30px" }}>
                          <div
                            ...
                            style={{
                              width: `${
                                (100 * stats.homeWins) / stats.matches
                              }%`,
                      ...
                      <div className="col-sm col-12 d-flex flex-column align-items-center justify-content-center">
                        ...
                        >
                          <div
                            ...
                            style={{
                              width: `${
                                (100 * stats.awayWins) / stats.matches
                              }%`,
                              backgroundColor: "red",
                            }}
                          />
                          ...
                          <tr scope="row" key={index}>
                            ...
                            <td className="text-center fw-bold align-middle">
                              <img
                                ...
                                alt="logo"
                              ></img>
                              {event_home_team} {event_final_result}{" "}
                              {event_away_team}
                              <img
                                class="upcoming-img mx-2"
                                src={away_team_logo}
